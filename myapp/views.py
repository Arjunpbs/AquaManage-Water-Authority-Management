    ...
    if request.method=="POST":
        ...
        if res.exists():
            ...
            if res2.Type=="admin":
                ...
                return HttpResponse('''<Script>alert("Login Sucessfull");window.location="readerhome/";</Script>''')
            elif res2.Type == "Rejected":
                return HttpResponse('''<Script>alert("Your connection has been Rejected. Please ");window.location="/ ";</Script>''')
            else:
...
def district_add_post(request):
    ...
    obj.save()
    return HttpResponse('''<Script>alert("ADDED");window.location="/district_add/";</Script>''')
...
def delete_District(request,id):
    ...
    return HttpResponse('''<Script>alert("Deleted");window.location="/View_District/";</Script>''')
...
def Add_meter_reader_post(request):
    ...
    obj.Phone=phone
    obj.save()
    return HttpResponse('''<Script>alert("Meter Reader Added");window.location="/Add_meter_reader/";</Script>''')
...
def delete_meter_reader(request,id):
    ...
    return HttpResponse('''<Script>alert("Deleted");window.location="/View_meter_reader/";</Script>''')
...
def edit_meter_reader_post(request):
    ...
    if 'fileField' in request.FILES:
        ...
        obj.Phone = phone
        obj.save()
        return HttpResponse('''<Script>alert("UPDATED");window.location="/View_meter_reader/";</Script>''')
    else:
        obj = Meterreader.objects.get(id=id)
        obj.Name = name
        obj.Gender = gender
...
def Add_area_post(request):
    ...
    obj.Place=place
    obj.save()
    return HttpResponse('''<Script>alert("Area Added");window.location="/Add_area/";</Script>''')
...
def delete_area(request,id):
    ...
    return HttpResponse('''<Script>alert("Deleted");window.location="/View_area/";</Script>''')
...
def Edit_area_post(request):
    ...
    return HttpResponse('''<Script>alert("Edited");window.location="/View_area/";</Script>''')
...
def Assign_meter_reader_post(request):
    ...
    obj.AREA=pp
    obj.save()
    return HttpResponse('''<Script>alert("Assigned");window.location="/Assign_meter_reader_get/";</Script>''')
...
def Edit_assigned_meter_readers_post(request):
    ...
    obj.AREA=pp
    obj.save()
    return HttpResponse('''<Script>alert("Edited");window.location="/View_assigned_mtr_reader/";</Script>''')

def delete_assigned_meter_reader(request,id):
    if request.session['lin']=='out':
        return redirect('login')
    dele=Assign_meter_reader.objects.get(id=id).delete()
    return HttpResponse('''<Script>alert("Deleted");window.location="/View_assigned_mtr_reader/";</Script>''')
...
def admin_view_connection_approve(request,id):
    ...
    return HttpResponse('''<Script>alert("Confirmed");window.location="/admin_view_connection/";</Script>''')
...
def Admin_add_Charge_post(request):
    ...
    if s== True:
        ...
        obj.Amount=amount
        obj.save()
        return HttpResponse('''<Script>alert("Charge Added");window.location="/Admin_add_Charge/";</Script>''')
    else:
        return HttpResponse('''<Script>alert("Charge already exists");window.location="/Admin_add_Charge/";</Script>''')
...
def admin_edit_charge_post(request):
    ...
    obj.Amount = amount
    obj.save()
    return HttpResponse('''<Script>alert("Edited");window.location="/admin_view_charge/";</Script>''')
...
def delete_charge(request,id):
    ...
    return HttpResponse('''<Script>alert("Deleted");window.location="/admin_view_charge/";</Script>''')
...
def Notification_send_post(request):
    ...
    obj.save()
    return HttpResponse('''<Script>alert("Notification Sented");window.location="/Notification_send/";</Script>''')
...
def Edit_notification_post(request):
    ...
    obj.Notification=noti
    obj.save()
    return HttpResponse('''<Script>alert("Edited");window.location="/view_notification/";</Script>''')
...
def view_due_report_deactivate(request,id):
    ...
    return HttpResponse('''<Script>alert("Deactivated");window.location="/view_due_report/";</Script>''')
...
def Change_password_admin_post(request):
    ...
    if res.exists():
        if newpass == confpass:
            ...
            return HttpResponse('''<Script>alert("Password Does Not Match");window.location="/Change_password_admin/";</Script>''')
    else:
...
def Usage_entry_post(request):
    ...
    if Usage.objects.filter(Usage__gt=usage, USER_id=id2).exists():
        return HttpResponse('''<Script>alert("Should Enter the usage Greater than previous");history.back()</Script>''')
    ...
    obj.USER_id=id2
    obj.save()
    return HttpResponse('''<Script>alert("Usage Entered");window.location="/view_assigned_area/";</Script>''')
...
def Change_pass_meter_post(request):
    ...
    if res.exists():
        if newpass == confpass:
            ress = Login.objects.filter(id=request.session['lid'], Password=oldpass).update(Password=newpass)
            return HttpResponse('''<Script>alert("Password Updated");window.location="/login/";</Script>''')
        else:
            return HttpResponse('''<Script>alert("Password Does Not Match");window.location="/Change_pass_meter/";</Script>''')
    else:
        return HttpResponse('''<Script>alert("Invalid");window.location="/Change_pass_meter/";</Script>''')
...
def edit_profile_post(request):
    ...
    if 'fileField' in request.FILES:
        ...
        obj.Village=village
        obj.save()
        return HttpResponse('''<Script>alert("UPDATED");window.location="/user_view_profile/";</Script>''')
    else:
        obj = User.objects.get(LOGIN__id=request.session['lid'])
        obj.Name = name
        obj.Gender = gender
...
def payment_form_post(request):
    ...
    if res.exists():
        ...
        if res1.Balance>=amount:
            ...
            return HttpResponse('''<script>alert('Payment Successfull');window.location="/userhome/"</script>''')
        else:
            return HttpResponse('''<script>alert('Insufficient Balance');window.location="/new_bill_pay/"</script>''')
    else:
        return HttpResponse('''<script>alert('Account Not Found');window.location="/new_bill_pay/"</script>''')
...
def user_upload_post(request):
    ...
    obj.save()
    return HttpResponse('''<Script>alert("UPLOADED");window.location="/user_upload/";</Script>''')
...
def complaintform_post(request):
    ...
    obj.TO_id=id
    obj.save()
    return HttpResponse('''<Script>alert("Complaint Sent");window.location="/Sent_complaint/";</Script>''')
...
def user_change_pass_post(request):
    ...
    if res.exists():
        ...
        return HttpResponse(
            '''<Script>alert("Invalid");window.location="/Change_pass_meter/";</Script>''')
            ...
            if newpass==confpass:
                ...
                if ress.exists():
                    ...
                    if resss.Balance>amt:
                        ...
                        messages.error(request,'Registration Completed  successfully!')
                        return redirect("login")
                    else:
                        messages.error(request,'Insufficient Balance!')
                        return redirect("New_conn")
...
def pub_complaint_sent(request):
    if request.method == "POST":
        ...
        obj.status='Pending'
        obj.save()
        messages.error(request,'Complaint registered successfully!')
        return redirect("login")
...
def forgot_pass(request):
    ...
    if request.method == "POST":
        ...
        if not qry.exists():
            ...
            server.starttls()
            server.login("akashmappoyil123@gmail.com", "iytvurhnnhrcxlma")  # App Password

            to = email
            subject = "Test Email"
            body = "Your new password is " + str(new_pass)
            msg = "Subject:"+ subject +"\n"+ body
            server.sendmail("akashmappoyil123@gmail.com", to, msg)

            
            server.quit()
            qryy = Login.objects.filter(Username=email).update(Password=new_pass)
            messages.error(request,'New password sended to your email successfully!')
            return redirect("login")
